...
from modules.model_mi import *
from modules.parser_mi import BiaffineParser
...
if __name__ == '__main__':
    ...
    #bert = BertEmbedding(data_path['pretrained']['bert_model'], nb_layers=args.bert_layer, fine_tune=False, merge='mean', use_proj=False, proj_dim=args.d_model)
    ...
    biff_parser = BiaffineParser(parser)
    biff_parser.summary()
